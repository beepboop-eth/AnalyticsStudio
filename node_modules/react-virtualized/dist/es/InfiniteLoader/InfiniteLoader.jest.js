  ...
  it('should call :recomputeGridSize if defined', function () {
    ...
    var TestComponent = function (_Component) {
      ...
      function TestComponent() {
        ...
        return _possibleConstructorReturn(this, (TestComponent.__proto__ || _Object$getPrototypeOf(TestComponent)).apply(this, arguments));
      }
    ...
    forceUpdateReactVirtualizedComponent(render(React.createElement(TestComponent, null)));
    expect(recomputedGridSize).toEqual(true);
  });

  it('should called :recomputeRowHeights if defined', function () {
    var recomputedRowHeights = false;
