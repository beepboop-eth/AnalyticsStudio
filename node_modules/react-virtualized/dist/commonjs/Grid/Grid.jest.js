...
var _defaultOverscanIndicesGetter = require('./utils/defaultOverscanIndicesGetter');
...
describe('Grid', function () {
  ...
  function simulateScroll(_ref2) {
    ...
    _reactAddonsTestUtils.Simulate.scroll((0, _reactDom.findDOMNode)(grid), { target: target });
  }
  ...
  describe('cell caching', function () {
    ...
    it('should clear cache once :isScrolling is false', function () {
      var _ref10 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(done) {
    ...
    it('should support a custom :scrollingResetTimeInterval prop', function () {
      var _ref13 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(done) {
        var cellRendererCalls, scrollingResetTimeInterval, cellRenderer, props, grid;
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                cellRenderer = function cellRenderer(_ref14) {
  ...
  describe('recomputeGridSize', function () {
    it('should recompute cell sizes and other values when called', function () {
      var columnIndices = [];
      var rowIndices = [];
      function columnWidth(_ref15) {
        var index = _ref15.index;

        columnIndices.push(index);
        return 10;
      }
      function rowHeight(_ref16) {
  ...
  describe('pure', function () {
    ...
    it('should not re-render grid components if they extend PureComponent', function () {
      ...
      function cellRenderer(_ref18) {
        var columnIndex = _ref18.columnIndex,
            key = _ref18.key,
    ...
    it('should clear all but the visible rows from the style cache once :isScrolling is false', function () {
      var _ref19 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(done) {
        var props, grid;
    ...
    it('should warn about CellMeasurer measured cells that forget to include the :style property', function () {
      ...
      cellRenderer.mockImplementation(function (params) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement('div', { key: params.key })
        );
      });
